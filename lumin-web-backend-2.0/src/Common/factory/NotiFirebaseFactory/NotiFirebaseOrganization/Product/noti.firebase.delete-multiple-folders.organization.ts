...
export class NotiFirebaseDeleteMultipleFoldersOrganization extends NotiFirebaseOrganizationBase {
  constructor(
  ...
  createContent(): string {
    const { actor, totalFolders, organization } = this.notiFirebaseOrganization;
    return `${actor.name} deleted ${totalFolders} folders from All ${organization.name}`;
  }
