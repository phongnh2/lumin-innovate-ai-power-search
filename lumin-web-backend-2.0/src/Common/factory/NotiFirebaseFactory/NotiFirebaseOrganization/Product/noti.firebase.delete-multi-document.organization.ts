...
export class NotiFirebaseDeleteMultiDocumentOrganization extends NotiFirebaseOrganizationBase {
  constructor(
  ...
  createContent(): string {
    const { organization, totalDocuments, actor } = this.notiFirebaseOrganization;
    return `${actor.name} deleted ${totalDocuments} documents from All ${organization.name}`;
  }
