...
export class NotiAnyoneCanJoinEnableAutomaticallyOrganization extends NotiFirebaseOrganizationBase {
  constructor(
  ...
  createContent(): string {
    const { organization } = this.notiFirebaseOrganization;
    return `The ${organization.name}'s ${ORGANIZATION_TEXT} was auto-changed to visible for anyone to join`;
  }
