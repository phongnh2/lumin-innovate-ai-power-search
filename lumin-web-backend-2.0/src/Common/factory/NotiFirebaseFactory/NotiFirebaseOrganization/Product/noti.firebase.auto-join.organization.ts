...
export class NotiFirebaseAutoJoinOrganization extends NotiFirebaseOrganizationBase {
  constructor(
  ...
  createContent(): string {
    const { actor, organization } = this.notiFirebaseOrganization;
    return `${actor.name} joined ${organization.name}'s ${ORGANIZATION_TEXT}`;
  }
