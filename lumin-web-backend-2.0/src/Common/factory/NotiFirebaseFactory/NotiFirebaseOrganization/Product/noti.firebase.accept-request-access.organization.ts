...
export class NotiFirebaseAcceptRequestAccessOrganization extends NotiFirebaseOrganizationBase {
  constructor(
  ...
  createContent(): string {
    const { organization } = this.notiFirebaseOrganization;
    return `You were accepted to join ${organization.name}'s ${ORGANIZATION_TEXT}`;
  }
