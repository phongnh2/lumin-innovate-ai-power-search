...
import { DocumentPersonalLevelGuardBase } from './document.personal.permission.guard';

@Injectable()
export class DocumentGuestLevelGuardBase extends DocumentPersonalLevelGuardBase implements CanActivate {
  constructor(
