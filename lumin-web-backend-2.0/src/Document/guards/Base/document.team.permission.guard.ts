...
import { DocumentOrganizationLevelGuardBase } from './document.organization.permission.guard';

@Injectable()
export class DocumentTeamLevelGuardBase extends DocumentOrganizationLevelGuardBase implements CanActivate {
  constructor(
