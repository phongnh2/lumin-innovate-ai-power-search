...
import { DocumentTeamLevelPipeBase } from 'Document/guards/Rest/TeamPipe/team.permission.base.pipe';
import { MembershipService } from 'Membership/membership.service';
import { OrganizationService } from 'Organization/organization.service';

export class DocumentPersonalLevelPipeBase extends DocumentTeamLevelPipeBase implements PipeTransform<unknown> {
  constructor(
  ...
  async transform(value: unknown, argument: ArgumentMetadata): Promise<unknown> {
    ...
    const isVerifySuccess = await VerifyDocumentPermissionBase.Personal({
