...
const DocumentItem = (props: DocumentItemProps) => {
  const { document, refetchDocument, openDocumentModal, containerScrollRef } = props;
        ...
        <>
          <div className={styles.infoContainer}>
            <div className={styles.info}>
              ...
              />
              <PlainTooltip content={document.name}>
                <Text type="title" size="sm" ellipsis>
                  <Highlighter searchWords={[state.searchKey]} autoEscape textToHighlight={documentName} />
                </Text>
              </PlainTooltip>
            </div>
